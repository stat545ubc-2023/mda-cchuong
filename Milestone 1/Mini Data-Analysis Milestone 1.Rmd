...
-   7 columns/variables (The top of the output lists the number of
    columns and there is one variable per column)

-   3 categorical/character variables : station_id, extreme_type and sym
    (Next to the variable names, the class is shown, in this case
    \<chr\>, which refers to the class "character")

-   4 numeric variables : year, month, day and flow (Next to the
    variable names, the class is shown, in this case \<dbl\>, which
    refers to the class "double")
...
-   17 categorical variables and 4 numeric (Next to the variable name,
    the class of the variable is given in the form \<class\> )
...
-   12 categorical variables, 7 numeric variables and 1 date variable
    (Next to the variable name, the class of the variable is given in
    the form \<class\> )
...
distributions of variables for people diagnosed with malignant tumors, so it 
makes sense to only use the observations where patients were diagnosed with 
...
2.  Do patients with malignant tumors tend to have larger/worse
    nuclei radius (radius_worse) than those with benign tumors?
